...
help () {
  echo "
    ...
    Flags:
      ...
      -f --fasttext   install fastText from the git repo
      -d --ftdl       download the wikipedia model for fasttext local to optimus
      -F --flair      install flair - includes models download
